...
for predicted_segmentation_file in predicted_segmentation_files:
    ...
    if check_intersection(jakub_polygon, rectangle_polygon):
        ...
        np.save('./Data2/{}_{}_{}_{}.npy'.format(x, y, patch_original_size, patch_resized_size),argmax_arr)
        copyfile(os.path.join(patch_directory,"{}_{}_{}_{}.png".format(x,y,patch_original_size,patch_resized_size)), './Data2/{}_{}_{}_{}.png'.format(x,y,patch_original_size,patch_resized_size))